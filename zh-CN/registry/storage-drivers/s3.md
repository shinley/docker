...
> **Note** You can provide empty strings for your access and secret keys to run the driver on an ec2 instance and will handle authentication with the instance's credentials. If you use [IAM roles](http://docs.aws.amazon.com/AWSEC2/latest/UserGuide/iam-roles-for-amazon-ec2.html), omit these keys to fetch temporary credentials from IAM.
