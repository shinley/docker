...
> **Note**: We'll get into the meaning of that command in [part 4](part4.md). If you don't run `docker swarm init` you'll get an error that "this node is not a swarm manager."
