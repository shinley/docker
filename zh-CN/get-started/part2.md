...
> **Tip**: Please use up-to-date Docker versions and clients to help the tutorial go swimmingly. For example, legacy apps like Docker Toolbox might give you unexpected results for local IP addresses and older versions of Docker do not support all features demo'ed here.
...
> **Note**: We'll be using Docker's public registry here just because it's free and pre-configured, but there are many public ones to choose from, and you can even set up your own private registry using [Docker Trusted Registry](/datacenter/dtr/2.2/guides/).

### Log in with your Docker ID

If you don't have a Docker account, sign up for one at [cloud.docker.com](https://cloud.docker.com/){: target="*blank" class="*" }. Make note of your username.
