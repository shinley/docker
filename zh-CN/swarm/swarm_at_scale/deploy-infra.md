...
3. Run <a href="https://hub.docker.com/r/progrium/consul/" target="_blank">the <code>consul</code> container</a>.
...
4. Use your favorite editor to create a `config.toml` file and add this content to the file:
